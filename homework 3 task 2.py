...
class Hash_class:
    ...
    def create_table(self):
        ...
        try:
            ...
            print('Таблица уже есть. Не добaвляем')
        else:
            self.conn.commit()
            print('Операция прошла успешно таблица добавлена в базу данных')
    ...
    def register(self):
        ...
        try:
            ...
            self.conn.commit()
            print('Операция прошла успешно, вы зарегестрированы')
    ...
    def log_in(self):
        ...
        if check_hash == out_hash[0]:
            ...
            print("Вввели неправильный пароль или еще не зарегестрировались")
